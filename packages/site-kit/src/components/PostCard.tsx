...
// 用到 useState（圖片載入狀態），必須是 client component。
// P4 之前它只被 client component 匯入，所以沒加也能過；進了 @ows/site-kit 的
// barrel 之後會被 server component 拉進去，指令就不能省。

import Link from 'next/link';
import Image from 'next/image';
import { useState } from 'react';
import { Content } from '@ows/platform-api/types';
import { formatDateTime, truncateText } from '@ows/ui/lib/utils';
