...
import { i18nApi } from '@ows/platform-api';
import { SUPPORTED_LANGUAGES, DEFAULT_LANGUAGE, LANGUAGE_REGION_LABELS, LANGUAGE_REGION_ORDER, type LanguageRegion } from '@ows/ui/lib/constants';
import AdminLayout from '../components/AdminLayout';
import Button from '@ows/ui/ui/Button';
import { Card, CardHeader, CardTitle, CardContent } from '@ows/ui/ui/Card';
