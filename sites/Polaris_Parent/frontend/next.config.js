...
const nextConfig = {
  ...
  // 轉譯 monorepo 內的套件
  transpilePackages: ['@ows/ui', '@ows/ziwei-chart', '@ows/platform-api', '@ows/admin-app', '@ows/content-kit', '@ows/site-kit', '@ows/ziwei-app', '@ows/commerce', '@ows/studio', '@ows/newsletter'],
  ...
  webpack: (config) => {
    config.resolve.alias = {
      ...
      '@ows/studio$': path.resolve(__dirname, '../../../packages/studio/src/index.ts'),
      '@ows/studio': path.resolve(__dirname, '../../../packages/studio/src'),
      '@ows/newsletter$': path.resolve(__dirname, '../../../packages/newsletter/src/index.ts'),
      '@ows/newsletter': path.resolve(__dirname, '../../../packages/newsletter/src'),
