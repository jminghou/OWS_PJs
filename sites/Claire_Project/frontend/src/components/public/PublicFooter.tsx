...
const footerContent: Record<string, {
  ...
  'zh-CN': {
    ...
    privacy: '隐私政策',
    terms: '使用条款',
    copyright: '© 2025 数位炼金室. 版权所有。',
  },
  'en': {
    siteName: 'Digital Alchemy Lab',
    ...
    copyright: '© 2025 Digital Alchemy Lab. All rights reserved.',
  },
  'ja': {
    siteName: 'デジタル錬金室',
    description: 'デジタルトランスフォーメーション、MarTech、EC成長を企業の長期的成長を支える堅固なアーキテクチャに変換します。',
    quickLinks: 'クイックリンク',
    home: 'ホーム',
    articles: 'インサイト',
    about: '私たちについて',
  ...
  return (
    <footer className="bg-brand-navy-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-brand-navy-700 pt-8 mt-8">
