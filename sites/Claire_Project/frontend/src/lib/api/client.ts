...
const getBaseUrl = () => {
  // 如果有環境變數就用環境變數，否則預設連向本地 5002
  if (typeof window === 'undefined') {
    return process.env.NEXT_SERVER_API_URL || process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:5002/api/v1';
  }
  return process.env.NEXT_PUBLIC_API_URL || 'http://127.0.0.1:5002/api/v1';
};
