"""
Claire Project Site - Application Entry Point

This module creates the Flask application instance for the Claire Project site.
...
Usage:
    ...
    gunicorn -w 4 -b 0.0.0.0:5000 "sites.Claire_Project.backend.app:app"
"""
...
from sites.Claire_Project.backend.config import config
...
SITE_EXTENSIONS = [
    # Add site-specific extensions here as needed
    # BlueprintConfig(
    #     module_path='sites.Claire_Project.backend.extensions.some_feature',
    #     url_prefix='/api/v1/some-feature',
    #     enabled=True
    # ),
]
...
def before_init(app):
    ...
    app.config.setdefault('SITE_NAME', 'Claire Project')
...
def after_init(app):
    ...
    try:
        from sites.Claire_Project.backend import models  # noqa: F401
    except ImportError:
...
def _register_cli_commands(app):
    ...
    def init_site():
        ...
        click.echo('Initializing Claire Project site data...')
