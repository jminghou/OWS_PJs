"""
Claire Project Site - Configuration
...
class Config:
    ...
    # -------------------------------------------------------------------------
    FRONTEND_REVALIDATE_URL = os.environ.get('FRONTEND_REVALIDATE_URL')  # e.g. https://www.clairelab.tw/api/revalidate
    REVALIDATE_SECRET = os.environ.get('REVALIDATE_SECRET')

    # -------------------------------------------------------------------------
    # Site-Specific Settings
    # -------------------------------------------------------------------------
    SITE_NAME = os.environ.get('SITE_NAME', 'Claire Project')
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = _get_database_url('DATABASE_URL',
        'postgresql+psycopg://postgres:postgres@localhost:5432/ows_claire_dev')
